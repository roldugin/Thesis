...
Throughout this chapter we will use a \name{Data Parallel Haskell} implementation of \QuickHull algorithm that computes the convex hull of a finite set of points in the plane. It derives its name from the QuickSort algorithm and similarly uses a divide and conquer approach.
