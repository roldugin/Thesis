...
\begin{hscode2}[%
    caption={\LiveFusion interface functions (partial list). Typeclass constraints on array elements have been omitted for brevity.},%
...
%\CommentPlusPlus{Explicit tupling. Compute both results.}%
...
data AST t where
  %\CommentPlusPlus[20em]{Flat combinators}% 
  Map         :: (Elt a, Elt b)
              => (Term a -> Term b)
              -> ArrayAST a
              -> ArrayAST b
  ...
  Replicate   :: Elt a
              ...
              -> Term a
              -> ArrayAST a
  %\CommentPlusPlus[20em]{Segmented combinators}%
  Fold_s      :: Elt a
              => (Term a -> Term a -> Term a)
              -> Term a
              -> ArrayAST Int
  ...
  Replicate_s :: Elt a
              ...
              -> ArrayAST a
              -> ArrayAST a
  %\CommentPlusPlus[20em]{Manifest arrays}%
  Manifest    :: Elt a
              => Vector a
              -> ArrayAST a
  %\CommentPlusPlus[20em]{Explicit tupling}%
