...
%To give a list analogy, the flat and segmented reductions would have the following types:
...
Recalling the \Loop language conventions, a single @elt@\sub{segd} element should be produced for every iteration of the outer loop.
...
\subsection{Segmented replicate and generators}
