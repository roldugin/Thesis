...
Segmented generators correspond to the category of combinators that \*produce* elements at the rate of data. They differ from combinators like @scanl_s@ discussed previously in that their
