...
While identifying loop anatomy provided a convenient way to fuse combinators to a common structure, Waters' work on \name{Series Expressions} identifies criteria for such combinators to be fusible. Series expressions are akin to combinators and can be directly compared. He presents the four main restrictions on the series expressions:
\begin{enumerate}
