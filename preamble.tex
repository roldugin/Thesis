...
%\usepackage{parskip} % apparently fixes skips between paragraphs
...
\lstnewenvironment{hscode2}[1]
    {\lstset{style=haskell, caption=#1}}
    {}
...
\lstnewenvironment{loopcode2}[2]
    {\lstset{style=haskell, float=htpb, label=#1, caption=#2}}
    {}
...
\providecommand{\ief}[1][]{\index{Equational fusion!#1}}
\providecommand{\iinl}[1][]{\index{inlining!#1}}
\providecommand{\irw}[1][]{\index{rewriting!#1}}
\providecommand{\irwr}[1][]{\index{rewrite rules!#1}}
\providecommand{\ighc}[1][]{\index{GHC (Glasgow Haskell Compiler)!#1}}
\providecommand{\iloop}[1][]{\index{Loop EDSL!#1}}
\providecommand{\ifusion}[1][]{\index{fusion!#1}}
...
%   - put \bib where appropriate
% - In chapter files:
%   - put \maybebib where appropriate
