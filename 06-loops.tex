...
int *ys = malloc(10 * sizeof(int)); // result array
...
The done blocks for the above arrays would look like the following:

\begin{loopcode}
done:
  ys' = frezeArray ys j   -- resize to length j
  return ys'
\end{loopcode}
