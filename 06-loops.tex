...
\begin{loopcode}
  ...
  body_abv:
    elt_abv = elt_adj
    guard (elt_above > 100) bottom_abv
    goto yield_abv
...
We have essentially presented the complete Loop representation for |Manifest|, |map| and |filter| combinators together with the code that actually deals with writing out physical arrays. However, it all came in separate loops none of which was very useful by itself. We will now show how these loops can be turned into a runnable loop.
