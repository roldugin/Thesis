...
\begin{loopcode}
  ...
  let result = freezeArray ys j   -- resize to length j
  return result
\end{loopcode}
...
For the purposes of illustration we will assume that the @toPercentage@ function is called with a @Manifest@ array as argument and the result is immediately \*forced* to be computed (e.g. to be printed out or to be consumed in a random access fashion).
