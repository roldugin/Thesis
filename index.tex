...
\providecommand{\ieqf}[1][]{\idx{equational fusion!#1}}
\providecommand{\iintermediate}[1][]{\idx{intermediate value!#1}}
\providecommand{\irate}[1][]{\idx{rate!#1}}
\providecommand{\isf}[1][]{\idx{fusion!Stream Fusion!#1}}
...
\providecommand{\icfg}[1][]{\idx{CFG (control flow graph)!#1}}
\providecommand{\idfd}[1][]{\idx{DFD (data flow diagram)!#1}}
% Also:
